...
public class TC_05 {
	...
	public void TestCase05() {
		...
		WebElement NewsLetter = driver.findElement(By.linkText("Subscribe / unsubscribe to newsletter"));
		scroll.moveToElement(NewsLetter).perform();
		driver.manage().timeouts().implicitlyWait(2, TimeUnit.SECONDS);
		driver.findElement(By.linkText("Subscribe / unsubscribe to newsletter")).click();

		Assert.assertTrue(driver.findElement(By.xpath("//div[@id = 'content']//h1")).isDisplayed());
		Assert.assertTrue(driver.findElement(By.xpath("//input[@name='newsletter' and @value = 1]")).isSelected());



		System.out.println(" 'Yes' option is  displayed as selected by default in the Newsletter page");
